...
const Hero = () => {
  return (
    ...
    >
      ...
      <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-aqua-light/20 rounded-full blur-3xl animate-float" />
      ...
      <div className="absolute top-1/2 right-1/3 w-64 h-64 bg-accent/15 rounded-full blur-2xl animate-wave" />
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            Available in 250ml, 500ml, and 1L — perfect for homes, offices, and events.
          </motion.p>
